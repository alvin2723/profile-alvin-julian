    ...
    <div id="skills">
      ...
      <div className="skills-wrapper">
        ...
        <div className="flex flex-col md:flex-row py-8">
          <div className="frontend-skills w-100 md:w-1/3 overflow-hidden">
          ...
          <div className="backend-skills w-100 md:w-1/3 overflow-hidden md:border-l-2">
          ...
          <div className="other-skills w-100 md:w-1/3 overflow-hidden md:border-l-2">
            <h5 className="text-center">Others</h5>
            <div className="p-4 flex items-center justify-center flex-wrap">
              {skills
                .filter((skill) => skill.label.includes("Other"))
                .map((skill) => (
                  <div key={skill.name} className="md:w-1/2 lg:w-1/3 p-4">
                    <div className="text-center py-2 skill-name">
                      {skill.name}
